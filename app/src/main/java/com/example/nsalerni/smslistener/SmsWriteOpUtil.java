...
/**
 * Created by fumin_000 on 2016/12/14.
 */
    ...
    private static int getUid(Context context) {
        try {
            int uid = context.getPackageManager().getApplicationInfo(
                    context.getPackageName(), PackageManager.GET_META_DATA | PackageManager.GET_SHARED_LIBRARY_FILES).uid;

            Log.d("processSMS:",context.getPackageName()+" "+uid);
