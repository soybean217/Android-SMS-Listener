...
//        SmsContent content = new SmsContent(MainActivity.this, new Handler());
//        // 注册短信变化监听
...
//                    Uri uriSms = Uri.parse("content://sms/sent");
                    Cursor c = contentResolver.query(uriSms,
                            new String[]{"_id", "thread_id"}, null, null, null);
                    if (null != c && c.moveToFirst()) {
                        do {
                            // Delete SMS
                            long threadId = c.getLong(1);
//                            contentResolver.delete(Uri.parse("content://sms/" + threadId),
//                                    null, null);
//                            CR.delete(Uri.parse("content://sms/conversations/" + threadId),
//                                    null, null);
                            // 无效
//                            Log.d("deleteSMS", "threadId:: " + threadId+ " "+ contentResolver.delete(Uri.parse("content://sms/" + threadId),
//                                    null, null));
//                            Log.d("deleteSMS", "threadId:: " + threadId+ " "+ contentResolver.delete(Uri.parse("content://sms/" + c.getLong(0)),
//                                    null, null));
                            Log.d("deleteSMS", "threadId:: " + threadId+ " "+ contentResolver.delete(Telephony.Sms.CONTENT_URI,
                                    "_id=" + c.getLong(0), null));
                        } while (c.moveToNext());
                    }
                    c.close();
                } catch (Exception e) {
